...
import com.kaka.ics.Fragment.Order_details_fragment;
import com.kaka.ics.Model.Booking_data;
import com.kaka.ics.Model.Cancel_order_responce;
import com.kaka.ics.Model.Pay_responce;
...
public class Booking_adapter extends RecyclerView.Adapter<Booking_adapter.ViewHolder>
{
    ...
    public void onBindViewHolder(final Booking_adapter.ViewHolder viewHolder, final int i) {
        if (viewHolder!=null) {
            ...
            else if (Integer.parseInt(ob.getStatus()) == 5)
            {
                ...
                viewHolder.ButtnWprogress.setVisibility(View.GONE);
                viewHolder.ButtnComplete.setVisibility(View.GONE);
                viewHolder.ButtnCashApprvl.setVisibility(View.VISIBLE);
            }
          ...
          ////////////
            ...
            if (Integer.parseInt(ob.getPayment_complete()) == 0)
            {
                ...
                viewHolder.pay_finish.setVisibility(View.GONE);
                viewHolder.advance.setVisibility(View.VISIBLE);
                viewHolder.amtpending.setVisibility(View.VISIBLE);
                viewHolder.advnc_gone.setVisibility(View.VISIBLE);
                viewHolder.pending_gone.setVisibility(View.VISIBLE);
            }
            ...
            else if (Integer.parseInt(ob.getPayment_complete()) == 1)
            {
                ...
                viewHolder.ButtnWprogress.setVisibility(View.GONE);
                viewHolder.ButtnComplete.setVisibility(View.GONE);
                viewHolder.ButtnCashApprvl.setVisibility(View.GONE);
                viewHolder.ButtnPaid.setVisibility(View.VISIBLE);

                viewHolder.pay_finish.setVisibility(View.VISIBLE);
                viewHolder.advance.setVisibility(View.GONE);
                viewHolder.amtpending.setVisibility(View.GONE);
                viewHolder.advnc_gone.setVisibility(View.GONE);
                viewHolder.pending_gone.setVisibility(View.GONE);
            }
            ...
            if (viewHolder.ButtnpayOnline.getVisibility() == View.VISIBLE)
            {
                viewHolder.ButtnpayOnline.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // Rupees 10 // callInstamojoPay(AppPrefrences.getMail(mactivity), AppPrefrences.getMobile(mactivity),""+10 ,"online payment", AppPrefrences.getName(mactivity),viewHolder,i);
                        callInstamojoPay(AppPrefrences.getMail(mactivity), AppPrefrences.getMobile(mactivity),ob.getTotalAmt() ,"online payment", AppPrefrences.getName(mactivity),viewHolder,i);
                        numpay = i;
                    }
                });
            }
    ...
    {
        TextView txnm, orderid , amtpending , dfrom , advance, pay, status, pending_gone,advnc_gone,pay_finish;
        Button ButtnpayCash, ButtnpayOnline, ButtnWprogress, ButtnCancel, ButtnComplete, ButtnCashApprvl;
        ImageView ButtnPaid;
        ...
        public ViewHolder(View itemview) {
            ...
            ButtnPaid= (ImageView) itemview.findViewById(R.id.button_paid);
            ButtnCashApprvl = (Button) itemview.findViewById(R.id.button_cashappr);
            pending_gone = (TextView) itemview.findViewById(R.id.hhead1);
            advnc_gone = (TextView) itemview.findViewById(R.id.hh3);
            pay_finish = (TextView) itemview.findViewById(R.id.tx_payfinish);
        }
    }
...
//      String  Payment_method = radio_online_pay.getText().toString();
    ...
    private void initListener(final ViewHolder itemview, final int a) {
        listener = new InstapayListener() {
            ...
            public void onFailure(int i, String s) {
                ...
                Toast.makeText(mactivity, "Error payment/transaction failed...", Toast.LENGTH_SHORT).show();
            }
    ...
    private void Call_PAY_API(int adv)
    {
        ...
        int advance;
        int payment = 1;
        ApiService.PAY_BOOK(AppPrefrences.getUserid(mactivity), order_id,payment,"online").enqueue(new Callback<Pay_responce>() {
        @Override
